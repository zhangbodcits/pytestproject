...
class TestSignCase:
    ...
    #     print(self.extract, 111111111111111)
    #     # 报告上展示的测试标题等
    #     report_setting(test_data)
    #     logger.info("*************** 结束执行用例 ***************\n")

    # def test_getLoginUser_case(self, test_data):
    #     logger.info("*************** 开始执行用例 ***************")
    #     # 报告展示的测试步骤
    #     report_step_setting(test_data)
    #     # 获取用户信息接口
    ...
    # 获取首页信息接口
    def test_getHomePageInfo_case(self, test_data):
        logger.info("*************** 开始执行用例 ***************")
        # 报告展示的测试步骤
        report_step_setting(test_data)
        result, self.extract = SendRequest(test_data, self.extract).send_request()
    ...
    # 获取托运人列表接口
    def test_getshipperlist_case(self, test_data):
        logger.info("*************** 开始执行用例 ***************")
        # 报告展示的测试步骤
        report_step_setting(test_data)
        result, self.extract = SendRequest(test_data, self.extract).send_request()
